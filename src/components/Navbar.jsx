...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 text-white flex justify-between items-center px-10 py-4 backdrop-blur-lg shadow-lg">
      ...
      {/* Navbar Items */}
      <ul
        className={`md:flex gap-6 items-center absolute md:static top-16 left-0 w-full bg-black md:bg-transparent md:w-auto flex flex-col md:flex-row transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <a
          href="/Shoaib_Shamrez_CV_WebDev.pdf"
          target="_blank"
